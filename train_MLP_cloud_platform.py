...
#
# NOTE: Model, metrics, and scaler files are saved directly to the
# current working directory, with no regard for path structures.
# ----------------------------------------------------
import os
import json
import pickle
...
# --- Configuration ---
DATA_FILE = "data.csv"
MODEL_FILENAME = "train_MLP_model.h5"
METRICS_FILENAME = "MLP_model_metrics.json"
SCALER_FILENAME = "scaler.pkl" 
# NOTE: os.makedirs("models", exist_ok=True) has been removed.
